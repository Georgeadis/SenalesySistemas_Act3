...
_start:
    ...
    sub al, 48          ; Convertir de ASCII a número real
    
    mov bl, [num2]      ; Mover el carácter del segundo número a 'bl'
    sub bl, 48          ; Convertir de ASCII a número real
    
    add al, bl          ; Sumar ambos números
    
    ; 6. Convertir el resultado de vuelta a ASCII para poder imprimirlo
    add al, 48          ; Convertir número real a carácter ASCII
